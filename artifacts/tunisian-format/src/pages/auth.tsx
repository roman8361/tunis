...
export default function AuthPage() {
  ...
  return (
    <BeachBackground>
      {/* Навигация сверху */}
      <div className="absolute top-5 left-0 right-0 flex justify-center gap-3 z-20">
        <button
          onClick={() => navigate("/about")}
          className="text-white/85 hover:text-white text-sm font-medium px-4 py-2 rounded-xl hover:bg-white/15 transition-all backdrop-blur-sm"
        >
          О сервисе
        </button>
        <button

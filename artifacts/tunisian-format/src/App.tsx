...
function RouteTournament({ id }: { id: string }) {
  ...
  const isClassic = tournament.format?.startsWith("classic-fixed") || tournament.format?.startsWith("classic-rotating") || tournament.format?.startsWith("classic4-fixed") || tournament.format?.startsWith("classic4-rotating");

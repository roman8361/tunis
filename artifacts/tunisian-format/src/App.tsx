...
function RouteTournament({ id }: { id: string }) {
  ...
  const isClassic = tournament.format === "classic-fixed" || tournament.format === "classic-rotating" || tournament.format?.startsWith("classic4-fixed") || tournament.format?.startsWith("classic4-rotating");
